...
export default function AuditoriaVotosPage() {
  ...
  const filtrosDaBusca = [agenciaId, diretorId, ano, tipoVoto, origem, soDivergentes, page] as const;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button className="btn-secondary gap-1.5 ml-auto" onClick={baixarCsv} disabled={demoEnabled || baixando}>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                {["DIRETOR", "AGÊNCIA", "DATA", "DELIBERAÇÃO", "RESULTADO", "VOTO", "COLEGIADO", "PDF"].map((h) => (
